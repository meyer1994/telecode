/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 90737dfdfc7845a221708ed65020f15e)
...
declare namespace Cloudflare {
	...
	interface Env {
		NITRO_BOT_TOKEN: string;
		NITRO_BOT_INFO: string;
		NITRO_CLOUDFLARE_API_TOKEN: string;
		NITRO_CLOUDFLARE_ACCOUNT_ID: string;
		DB: D1Database;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NITRO_BOT_TOKEN" | "NITRO_BOT_INFO" | "NITRO_CLOUDFLARE_API_TOKEN" | "NITRO_CLOUDFLARE_ACCOUNT_ID">> {}
}
